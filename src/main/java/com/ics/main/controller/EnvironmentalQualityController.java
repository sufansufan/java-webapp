 ...
 */
@Controller
@RequestMapping(value ="/environmentalQuality")
public class EnvironmentalQualityController {
	
	protected static final String indexJsp="views/environmentalQuality/index";
