 ...
 */
@Controller
@RequestMapping(value ="/environmentalSupervision")
public class EnvironmentalSupervisionController {
	
	protected static final String indexJsp="views/environmentalSupervision/index";
