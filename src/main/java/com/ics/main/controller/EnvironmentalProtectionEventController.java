 ...
 */
@Controller
@RequestMapping(value ="/environmentalProtectionEvent")
public class EnvironmentalProtectionEventController {
	
	protected static final String indexJsp="views/environmentalProtectionEvent/index";
