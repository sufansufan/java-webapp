...
public class SystemController {
	...
	protected static final String indexJsp="views/system/index";
	...
	public ModelAndView index(HttpServletRequest request, String authId, String point, String nodeId) {
		...
		Map<String, List<SysAuthority>> authMap = authList.stream().collect(Collectors.groupingBy(SysAuthority::getAuthorityParentId));
