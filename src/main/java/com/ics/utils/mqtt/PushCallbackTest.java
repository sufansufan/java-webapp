...
import com.ics.main.controller.MainController;
...
import com.ics.utils.HttpRequest;
import com.ics.utils.MailUtil;
import com.ics.utils.StringUtil;

/**
 * Created by StoneGeek on 2018/6/5. 博客地址：http://www.cnblogs.com/sxkgeek
 * 发布消息的回调类
 *
...
public class PushCallbackTest implements MqttCallback {
	protected static Logger logger = Logger.getLogger(PushCallbackTest.class);
