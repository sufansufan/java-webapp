...
function loadScript() {
	...
	script.src = "https://webapi.amap.com/maps?v=1.3&key=" + key +"&callback=init&plugin=AMap.MarkerClusterer";
...
function geocoder_CallBack(data) {
    ...
    if($("#localLng").val()==undefined || $("#localLng").val()==""){
    	$("#installAddress").val(address);
    }else{
    	if(isEdit){
