...
function searchHistoryRecordList() {
	...
	console.log(storage_enterpriseId)
	//获取完先移除当前的缓存
//	sessionStorage.removeItem("enterpriseId")
	sessionStorage.removeItem("condensingDeviceNum")
	 if(storage_enterpriseId!=null){
		 if(index==0){
			 index++;
			 $("#dayOperationTrend-content [name='enterpriseId']").val(storage_enterpriseId);
	...
	openLoading();
	var params = {};
	var enterpriseId = $("#dayOperationTrend-content [name='enterpriseId']").val();
	var condensingDeviceNum = $("#dayOperationTrend-content [name='condensingDeviceNum']").val();
	 var query_startTime = $("#dayOperationTrend-content [name='query_startTime']").val();
	 var query_endTime = $("#dayOperationTrend-content [name='query_endTime']").val();
	 if(storage_enterpriseId!=null){
...
function changeCondensingDeviceList(storage_condensingDeviceNum){
	...
	$.post("remoteMonitor/operationTrend/changeCondensingDevice.do",params,function(data){
	    ...
	    if(storage_condensingDeviceNum!=null){
	    	 $("#dayOperationTrend-content [name='condensingDeviceNum']").val(storage_condensingDeviceNum);
	    }
...
function loadHistoryRecordInfo(params){
	$.post("remoteMonitor/dayOperationTrend/historyRecordList.do",params,function(data){
		closeLoading();
...
//				html +="<td style='width:70px'>--</td>";
//			}
//			if(pressureValue[1]!=null){
//				html +="<td>"+pressureValue[1]+"</td>";
//			}else{
//				html +="<td>--</td>";
//			}
//			if(pressureValue[2]!=null){
//				html +="<td>"+pressureValue[2]+"</td>";
//			}else{
//				html +="<td>--</td>";
//			}
//			if(pressureValue[3]!=null){
//				html +="<td>"+pressureValue[3]+"</td>";
//			}else{
//				html +="<td>--</td>";
//			}
//			if(pressureValue[4]!=null){
//				html +="<td>"+pressureValue[4]+"</td>";
//			}else{
//				html +="<td>--</td>";
//			}
//			if(pressureValue[5]!=null){
//				html +="<td>"+pressureValue[5]+"</td>";
//			}else{
//				html +="<td>--</td>";
//			}
//			if(pressureValue[6]!=null){
//				html +="<td>"+pressureValue[6]+"</td>";
//			}else{
//				html +="<td>--</td>";
//			}
//			if(pressureValue[7]!=null){
//				html +="<td>"+pressureValue[7]+"</td>";
//			}else{
//				html +="<td>--</td>";
//			}
//			if(pressureValue[8]!=null){
//				html +="<td>"+pressureValue[8]+"</td>";
//			}else{
//				html +="<td>--</td>";
//			}
//			html +="</tr>";
...
//				html +="<td style='width:70px'>--</td>";
//			}
//			if(temperatureValue[1]!=null){
//				html +="<td>"+temperatureValue[1]+"</td>";
//			}else{
//				html +="<td>--</td>";
//			}
//			if(temperatureValue[2]!=null){
//				html +="<td>"+temperatureValue[2]+"</td>";
//			}else{
//				html +="<td>--</td>";
//			}
//			if(temperatureValue[3]!=null){
//				html +="<td>"+temperatureValue[3]+"</td>";
//			}else{
//				html +="<td>--</td>";
//			}
//			if(temperatureValue[4]!=null){
//				html +="<td>"+temperatureValue[4]+"</td>";
//			}else{
//				html +="<td>--</td>";
//			}
//			if(temperatureValue[5]!=null){
//				html +="<td>"+temperatureValue[5]+"</td>";
//			}else{
//				html +="<td>--</td>";
//			}
//			if(temperatureValue[6]!=null){
//				html +="<td>"+temperatureValue[6]+"</td>";
//			}else{
//				html +="<td>--</td>";
//			}
//			if(temperatureValue[7]!=null){
//				html +="<td>"+temperatureValue[7]+"</td>";
//			}else{
//				html +="<td>--</td>";
//			}
//			html +="</tr>";
...
//				html +="<td>--</td>";
//			}
//			if(vibrationValue[1]!=null){
//				html +="<td>"+vibrationValue[1]+"</td>";
//			}else{
//				html +="<td>--</td>";
//			}
//			html +="</tr>";
...
//				html +="<td>--</td>";
//			}
//			if(electricValue[1]!=null){
//				html +="<td>"+electricValue[1]+"</td>";
//			}else{
//				html +="<td>--</td>";
//			}
//			html +="</tr>";
...
//				html +="<td>--</td>";
//			}
//			if(positionValue[1]!=null){
//				html +="<td>"+positionValue[1]+"</td>";
//			}else{
//				html +="<td>--</td>";
//			}
//			if(positionValue[2]!=null){
//				html +="<td>"+positionValue[2]+"</td>";
//			}else{
//				html +="<td>--</td>";
//			}
//			if(positionValue[3]!=null){
//				html +="<td>"+positionValue[3]+"</td>";
//			}else{
//				html +="<td>--</td>";
//			}
//			if(positionValue[4]!=null){
//				html +="<td>"+positionValue[4]+"</td>";
//			}else{
//				html +="<td>--</td>";
//			}
//			if(positionValue[5]!=null){
//				html +="<td>"+positionValue[5]+"</td>";
//			}else{
//				html +="<td>--</td>";
//			}
//			if(positionValue[6]!=null){
//				html +="<td>"+positionValue[6]+"</td>";
//			}else{
//				html +="<td>--</td>";
//			}
//			if(positionValue[7]!=null){
//				html +="<td>"+positionValue[7]+"</td>";
//			}else{
//				html +="<td>--</td>";
//			}
//			if(positionValue[8]!=null){
//				html +="<td>"+positionValue[8]+"</td>";
//			}else{
//				html +="<td>--</td>";
//			}
//			html +="</tr>";
...
//		}
		...
		for(i=0;i<pressureFactorNameArr.length;i++){
			var monitorFactorParam ={};
			    ...
			    monitorFactorParam['type']='scatter';
...
function chooseDate(flag){
	...
	if(flag==1){
	    ...
	    $("#dayOperationTrend-content [name='query_startTime']").val(startTime);
		$("#dayOperationTrend-content [name='query_endTime']").val(endTime);
	}else if(flag==2){
...
function exportHistoryRecord(flag){
	...
	var query_startTime = $("#dayOperationTrend-content [name='query_startTime']").val();
	var query_endTime = $("#dayOperationTrend-content [name='query_endTime']").val();
    window.location.href="remoteMonitor/dayOperationTrend/exportHistoryRecordList.do?enterpriseId=" + enterpriseId + "&query_startTime=" + query_startTime + "&query_endTime=" + query_endTime+"&condensingDeviceNum=" + condensingDeviceNum+"&flag="+flag;
    closeLoading();
}
