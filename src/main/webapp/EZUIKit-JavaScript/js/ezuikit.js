...
(function (global, factory) {
  ...
  EZUIPlayer.prototype.initDecoder = function (playParams) {
    ...
    function initDecoder(resolve, reject) {
      var jsPluginPath = playParams.decoderPath + 'EZUIKit-JavaScript/js/jsPlugin/jsPlugin-1.2.0_test.js';
      ...
      addJs(jsPluginPath, function () {
        ...
        _this.jSPlugin = new JSPlugin({
          ...
          szBasePath: playParams.decoderPath + 'EZUIKit-JavaScript/js/',
        });
        _this.log("初始化解码器----完成");
        _this.log("开始设置秘钥");
      ...
      if (!window.localStorage) {
        request(
          playParams.decoderPath + "EZUIKit-JavaScript/js/errorCode.json",
          "get",
          {
            language: 1,
