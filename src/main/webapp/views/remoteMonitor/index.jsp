...
<!--       		<li class="layui-nav-item"> -->
      		<li class="${item.authorityName=='机组信息'?'layui-nav-item layui-nav-itemed':'layui-nav-item'}">
	      		<a class="first-menu" id="${item.authorityCode}" href="javascript:;" 
	      		...
	      		<c:if test="${fn:length(authMap[item.id])>0}">
		      		<dl class="layui-nav-child">
		      			<c:forEach items="${authMap[item.id]}" var="childItem" varStatus="cvs">
		      				<dd>
		      					<a class="second-menu"  id="${childItem.authorityCode}" href="javascript:;" 
