...
<div class="layui-form" action="" style="padding: 20px">
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<input type="text" name="factorCode" value="${model.factorCode}" lay-verify="required|textMaxlength|uniqueFactorCode" class="layui-input">
		</div>
	</div>
	<div class="layui-form-item">
...
$(function(){
	...
	form.on('submit(monitorFactorButton)', function(data) {
		monitorFactorAddEditSave(data.field,2);
		return false;
	});
	//监听类型改变
