...
<div class="layui-form" action="" style="padding: 20px">
	...
	<input type="hidden" id="authorityParentId" name="authorityParentId" value="${model.authorityParentId}">
	...
	<div class="layui-form-item" id="authorityTypeDiv">
		<div class="layui-inline"> 
			...
			<div class="layui-input-inline">
				<select id="authorityType" name="authorityType" lay-filter="modelSl" lay-verify="required"> 
	...
	<div class="layui-form-item" style="text-align: right; padding-top: 15px;">
		<button class="layui-btn layui-btn-normal" lay-submit="" lay-filter="sysAuthorityeditButton">提交</button>
...
$(function(){
	...
	//监听提交
	form.on('submit(sysAuthorityeditButton)', function(data) {
		sysAuthorityEditSave(data.field);
		return false;
	});
</script>