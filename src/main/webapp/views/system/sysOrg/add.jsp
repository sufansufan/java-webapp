...
<div id="sysOrgForm" class="layui-form" action="" style="padding:20px">
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<input type="text" name="orgCode" lay-verify="required|sysOrgtitle|sysOrgunique|specialChar" maxlength="12" value="${model.orgCode }" autocomplete="off" placeholder="请输入编码" class="layui-input">
		</div>
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<input type="text" name="orgName" lay-verify="required|sysOrgtitle|specialChar|sysOrguniqueName" maxlength="12" value="${model.orgName }" autocomplete="off" placeholder="请输入名称" class="layui-input">
		</div>
	</div>
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<input type="text" name="sortIdx" maxlength="2" lay-verify="myNumber|specialChar|gt0" value="${model.sortIdx==100?'':model.sortIdx}" autocomplete="off" placeholder="从小到大排序" class="layui-input">
		</div>
	</div>
	    ...
	    sysOrgunique: function(value){
	    	...
	    	$.ajax({  
		         type : "get",  
		          ...
		          data : {code:value,id:$("input[name='id']").val()},  
		          async : false,  
		          dataType: "json",
	    ...
	    sysOrguniqueName: function(value){
	    	...
	    	$.ajax({  
		         type : "get",  
		          ...
		          data : {str:value,id:$("input[name='id']").val(),parentId:$("input#parentId").val()},  
		          async : false,  
		          dataType: "json",
		          success : function(data){  
		          	flag = data.success;
